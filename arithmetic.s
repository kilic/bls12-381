...
TEXT ·sub12(SB), NOSPLIT, $0-24
	...
	MOVQ $0, R12
	MOVQ $0, R13
	CMOVQCS ·modulus+0(SB), R8
	CMOVQCS ·modulus+8(SB), R9
	CMOVQCS ·modulus+16(SB), R10
	CMOVQCS ·modulus+24(SB), R11
	CMOVQCS ·modulus+32(SB), R12
	CMOVQCS ·modulus+40(SB), R13
	ADDQ R8, R14
	ADCQ R9, R15
	ADCQ R10, AX
	ADCQ R11, BX
